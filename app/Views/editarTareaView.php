...
<body>
    ...
    <div class="container">
        <h1 class="titulo-principal">Editar Tarea</h1>
        ...
        <div class="form-container">
            <form action="<?= base_url('tarea/actualizar') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" value="<?= esc($tarea['titulo']) ?>" required>
                </div>
                
                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción:</label>
                    <textarea class="form-control" id="descripcion" name="descripcion"><?= esc($tarea['descripcion']) ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha_vencimiento" name="fecha_vencimiento" value="<?= esc($tarea['fecha_vencimiento']) ?>">
                </div>
                
                <div class="mb-3">
                    <label for="fecha_recordatorio" class="form-label">Fecha de recordatorio:</label>
                    <input type="date" class="form-control" id="fecha_recordatorio" name="fecha_recordatorio" value="<?= esc($tarea['fecha_recordatorio']) ?>">
                </div>
                
                <div class="mb-3">
                    <label class="form-label">Color:</label>
                    <div class="color-options">
                        <div class="color-option <?= $tarea['color'] == 'rojo' ? 'selected' : '' ?>" style="background-color: #B00020;" data-color="rojo" onclick="selectColor('rojo')"></div>
                        <div class="color-option <?= $tarea['color'] == 'azul' ? 'selected' : '' ?>" style="background-color: #0D47A1;" data-color="azul" onclick="selectColor('azul')"></div>
                        <div class="color-option <?= $tarea['color'] == 'verde' ? 'selected' : '' ?>" style="background-color: #1B5E20;" data-color="verde" onclick="selectColor('verde')"></div>
                        <div class="color-option <?= $tarea['color'] == 'naranja' ? 'selected' : '' ?>" style="background-color: #E65100;" data-color="naranja" onclick="selectColor('naranja')"></div>
                        <div class="color-option <?= $tarea['color'] == 'celeste' ? 'selected' : '' ?>" style="background-color: #0288D1;" data-color="celeste" onclick="selectColor('celeste')"></div>
                        <div class="color-option <?= $tarea['color'] == 'gris' ? 'selected' : '' ?>" style="background-color: #424242;" data-color="gris" onclick="selectColor('gris')"></div>
                        <div class="color-option <?= $tarea['color'] == 'violeta' ? 'selected' : '' ?>" style="background-color: #6A1B9A;" data-color="violeta" onclick="selectColor('violeta')"></div>
                    </div>
                    <input type="hidden" id="color" name="color" value="<?= esc($tarea['color']) ?>">
                </div>
